...
public class multi extends darah {
    ...
    int boption, option, pbattle = 0, ebattle = 0, round, ulang, uulang = 0, menu, restart, tryerror;
    ...
    public void status() {
        System.out.println("*************************************************************");
        System.out.println("| Player 1 health : " + phealth + "\t\t\tplayer 2 health : " + ehealth);
        System.out.println("| Player 1 mana   : " + pmana + "\t\t\tplayer 2 mana   : " + emana);
        System.out.println("*************************************************************");
...
// untuk pemilihan char dari player2        
        do {
            try {
                tryerror = 1;
                    ...
                    if (ebattle == 2) {  //bot tamara char
                        do {
                            try {
                                ...
                                soption = nilai.next();
                                option = Integer.parseInt(soption);
                                if (option == 1) {  //bot tamara spell 1
                                ...
                                if (option == 2) { //bot tamara spell 2
                                ...
                                if (option == 3) { //bot tamara spell 3
                                ...
                                if (option == 4) {  //bot tamara spell 4
                                    spell_tambah(0, 0, 0, 30);
                                    bug();
                                    status();
                                }
